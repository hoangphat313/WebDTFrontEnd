...
const DetailsOrderPage = () => {
  ...
  return (
   ...
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: 'fit-content', background: '#fff'}}>
      <div style={{ width: '1270px', margin: '0 auto', height: 'fit-content'}}>
        <div style={{fontSize:'16px',fontWeight:'bold',margin:'30px auto'}}>Chi tiết đơn hàng</div>
        <WrapperHeaderUser>
        ...
        <WrapperStyleContent>
          <div style={{flex:1,display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
            <div style={{width: '670px',fontSize:'15px',fontWeight:'700'}}>Sản phẩm</div>
